      ...
      >
        <Grid item md={8} lg={8}>
          ...
          <Paragraph>
            ...
            automatically for you. Just run the below command <HighlightText>Tata Safari</HighlightText> only the
            response time. This is an example of the link <Link href="/">one moment link of Next.js in here </Link>
            of the whole webpage dude...!
          </Paragraph>

          <HighlightText>Hi Bro this is the highlighted text ink kkkk...</HighlightText>
