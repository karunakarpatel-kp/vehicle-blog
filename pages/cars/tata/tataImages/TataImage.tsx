// export const TataImageList = {
//   coloredGrill: "/pages/cars/tata/tataImages/colored-grille.jpg",
//   comfortHeadrest: "../tataImages/2nd-row-comfort-headrest.jpg",
//   acVents: "../tataImages/3rd-row-ac-vents.jpg",
// };
import grillImage from "./colored-grille.jpg";
import fullLedProjectorImage from "./full-led-projector-head-lamp-27-23.jpg";
...
export const TataImagesList = {
  grillImage,
  fullLedProjectorImage,
  ledlight,
  connectedLEDDRLs,
  signatureLedTailLamp,
  alloyWheels,
  singatureMascot,
  roofRails,
  interiorTheme,
  ...
  harmanAudioImage,
  harmanTouchImage,
  instrumentClusterImage,
  connectedTechnologyImage,
  jblMusicImage,
  androidAutoImage,
  voiceAssistantImage,
  kryotechImage,
  ...
  gestureTailgateImage,
  dualZoneImage,
  ventilatedSeatsImage,
  poweredSeatsImage,
  electricBossImage,
  headRestImage,
  luxuriousRowImage,
  acVentsImage,
  intelligentSpacesImage,
  airPurifierImage,
...
export const TataImagesListArray = [
  grillImage,
  fullLedProjectorImage,
  ledlight,
  connectedLEDDRLs,
