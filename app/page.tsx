...
export default function Home() {
  return (
    <>
      <div className="LoadingUI grid  md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-14 mt-8 mb-8">
        {blogPostsObj.map((singleBlogPost, index) => {
          return (
            <div
              key={index}
              className="animation-pulse shadow-xl mt-0 m-auto p-5 no-underline ring-1 ring-gray-200 dark:ring-slate-600 rounded-md hover:bg-slate-100 dark:bg-slate-900 dark:hover:bg-slate-900 "
            >
