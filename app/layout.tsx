...
const RootLayout = (props: RootLayoutProps) => {
  ...
  return (
    <html lang="en" className={darkMode ? "dark transition-colors duration-100" : "transition-all duration-300"}>
      <body className="relative p-0 m-0 bg-white dark:bg-slate-900 dark:prose-invert prose prose-stone min-h-screen max-w-full border-0 border-sky-400 h-[100%] overflow-x-hidden">
        <header>
          <Navigation />
        </header>
